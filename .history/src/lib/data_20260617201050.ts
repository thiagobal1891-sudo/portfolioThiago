...
export const projects = [
  ...
  year: "2024",
  description: "Landing page profesional para un centro de cosmetología con agenda online y diseño responsive.",
  what: "Desarrollé la estructura completa en HTML semántico, los estilos con SCSS organizado en módulos, y las interacciones con JavaScript vanilla. Incluye animaciones por scroll con Intersection Observer y un formulario de contacto funcional.",
  problem: "La clienta necesitaba una presencia online que transmitiera confianza y profesionalismo, con una forma clara de que sus clientes pudieran ver los servicios y contactarla.",
  solution: "Diseñé y construí la landing desde cero sin frameworks, priorizando velocidad de carga y una experiencia visual limpia. El resultado fue un sitio deployado en Netlify con carga rápida y navegación fluida en mobile.",
